...
import { loadTopOss } from "@/services/actions/analytics/emotes";
...
const columns = [
  ...
  {
    name: (
      <TooltipContainer className="text-center" tooltip="Total clicks on reactions">
        Reactions
      </TooltipContainer>
    ),
    selector: "count",
...
const TechOssPane = () => {
  ...
  const { top_oss, top_oss_loading } = analyticsStore.emotes;
  ...
  return (
    <>
      {!top_oss_loading && <WhiteLineChart data={top_oss} />}
      <div className="d-flex mg-y-10 pd-y-2 align-items-center">
        ...
        <div className="d-flex">
          ...
          <ExportToExcel
            ...
            fileName={`analytics_emotes_top_os_${
