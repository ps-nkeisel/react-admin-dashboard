...
import { loadTopDevices } from "@/services/actions/analytics/emotes";
  ...
  },
  {
    name: (
      <TooltipContainer
        ...
        tooltip="Total clicks on reactions"
      >
        Reactions
      </TooltipContainer>
    ),
...
const TechDevicesPane = () => {
  ...
  const { top_devices, top_devices_loading } = analyticsStore.emotes;
      ...
      <div className="d-flex mg-y-10 pd-y-2 align-items-center">
        ...
        <div className="d-flex">
          ...
          <ExportToExcel
            ...
            fileName={`analytics_emote_top_devices_${
